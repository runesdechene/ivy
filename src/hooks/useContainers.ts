...
export type ContainerInstance = {
  ...
  value_cost: number;
  value_sale: number;
  variants: { id: string; title: string; product_id: string; product_title: string; product_type: string | null; color: string | null; color_hex: string | null; size: string | null; qty: number }[];
};
